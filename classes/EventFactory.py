...
class Event:
    def __init__(self, 
                 ...
                 cause: str,
                 cause_event_id: str,
                 parent_segment_id: str):  # Added cause parameter
        self.id = event_id
        ...
        self.cause = cause  # Added cause attribute
    ...
    def __str__(self):
        return (f"event_id={self.id}, "
                ...
                f"cause='{self.cause}'")  # Added cause to string representation
    ...
    def get_cause(self) -> str:  # Added getter for cause
        return self.cause

    def set_cause(self, cause: str):  # Added setter for cause
        self.cause = cause
...
class EventFactory:
    ...
    def create_event(self, event_id:str, event_type: str, start_time: int, 
    ...
    def create_events_from_json(self, json_file_path: str, segment_id: str, target_list: List[Target] = None) -> List[Event]:
        ...
        for event_data in events_data:
            ...
            event = Event(
                ...
                current_time=event_data.get('current_time', 0),  # Default to 0 if current_time is not provided

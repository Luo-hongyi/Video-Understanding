...
class VectorStore:
    ...
    def build_by_param(self, story_docs, event_docs, target_docs, segment_docs, time_interval: int = 60):
        ...
        self.global_story_vectorstore = Chroma.from_documents(documents=story_docs, embedding=OpenAIEmbeddings(api_key=""), collection_name="global_story_vectorstore")
        self.global_event_vectorstore = Chroma.from_documents(documents=event_docs, embedding=OpenAIEmbeddings(api_key=""), collection_name="global_event_vectorstore")
        self.global_target_vectorstore = Chroma.from_documents(documents=target_docs, embedding=OpenAIEmbeddings(api_key=""), collection_name="global_target_vectorstore")
        self.global_segment_vectorstore = Chroma.from_documents(documents=segment_docs, embedding=OpenAIEmbeddings(api_key=""), collection_name="global_segment_vectorstore")
